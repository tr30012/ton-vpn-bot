...
from vpnbot.orm.pool import AsyncExecute
from vpnbot.orm.queries import update_user_language, select_users_languages
from vpnbot.utils.locales import get_default_language
...
def ll(telegram_id: int, code: str) -> str:
    if telegram_id in __users:
        ...
        return __locales[get_default_language()][code]
